...
Дневные журналы и ревизии текущей стабилизации:
...
- [x] Раздел `/research` дополнен рабочим планом MLCC/nonlinear capacitor distortion research program и ссылкой на полный Markdown-документ.
