...
- [x] Добавлены страницы `/research`, `/tools`, `/publications`, `/lab-notes`, `/projects`, `/courses`, `/about`, `/subscribe`, `/consulting`.
...
- [x] Добавлены SEO-заготовки инструментов `/tools/adc-enob-loss-calculator` и `/tools/capacitor-distortion-analyzer`.
