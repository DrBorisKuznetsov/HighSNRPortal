...
С 2026-07-16 инструменты явно привязаны к рабочему плану `Capacitor Research`:

- ADC Input Stage Simulator поддерживает ветку про влияние MLCC/нелинейной емкости на входные цепи АЦП и системные метрики ENOB/SINAD/THD.
- Passive Filter Distortion Analyzer поддерживает ветку THD-методологии для пассивных фильтров с Class II MLCC.
- Будущие измерительные и NPR-инструменты должны связываться с веткой аппаратной валидации, а не создаваться как отдельные research-разделы.

Полный план хранится в `wiki/research/2026-07-16-mlcc-research-directions.md`.
